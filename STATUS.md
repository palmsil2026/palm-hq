...
| GAS คุณเลขา (`secretary/Code.gs`) — บอท LINE + บอร์ด + exec API + HR | Apps Script deployment `AKfycbwgxZ_yxK21-GcB0yuZSFw-uT7yr9J322ZyMT2H3QsHgcnEuvvhUP3I-yJH3hq9dC9J` | ⏳ **ตามหลัง main 1 commit** — รอวาง `CODE_VERSION = 2026-08-18b` (พนักงานถามยอดร้านในกลุ่ม Old Days ได้) · พิมพ์ "เช็คระบบ" ในไลน์เพื่อยืนยันเวอร์ชันที่รันจริง |
