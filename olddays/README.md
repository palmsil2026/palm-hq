...
- **เข้าคนเดียว ไม่มีการหาร** — ในฟอร์มปิดยอดเลือก "คนรับค่าคอมวันนี้" 1 คน
  (ปกติคือเนส วันไหนเนสหยุดเลือกคนที่รับแทน เช่น มีนา — คนอื่นที่มาช่วยติ๊ก "เข้ากะ" ได้แต่ไม่กระทบค่าคอม)
- เจ้าของร้าน (owner) ไม่โผล่ในตัวเลือกเข้ากะ/ค่าคอม
- แก้เรตได้ที่แท็บ `Config` → `COMMISSION_PER_CUP`
- ค่าคอมแสดงเฉพาะตอนปิดยอดรายวัน (ฟอร์ม, หน้าสำเร็จ, การ์ดในกลุ่ม LINE) —
  ไม่โชว์สะสมบน dashboard/รายงานในแอป เจ้าของดูยอดรวมได้ที่แท็บ `Commission` ใน Sheet
